...
**Date** : 2026-08-04T07:44:02.357677+00:00
...
- Score technique avant pénalité : **7.0/10**
...
| V — Souveraineté | 9.0/10 | 15% | 90% | bon | Playwright Dynamic Flow Mapping |
...
- **V — Souveraineté** : 1 destination(s) apparente(s) hors Canada.
...
- DOMContentLoaded observé à 92 ms.
...
- 1 destination(s) réseau observée(s).
...
- `{"domContentLoaded": 92.30000001192093, "firstContentfulPaint": 108, "loadEvent": 92.40000000596046, "responseStart": 86.90000000596046, "transferSize": 618, "type": "navigation_timing", "wallTime": 619.8}`
